...
extern "C" IL2CPP_METHOD_ATTR float Vector2_SqrMagnitude_m2414967581 (RuntimeObject * __this /* static, unused */, Vector2_t2156229523  ___a0, const RuntimeMethod* method)
{
	float V_0 = 0.0f;
	{
		float L_0 = (&___a0)->get_x_0();
